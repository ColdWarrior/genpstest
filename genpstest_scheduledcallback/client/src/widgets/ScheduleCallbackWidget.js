...
(function (global, $, _, Promise, RestApi) { // eslint-disable-line no-unused-vars
    ...
    var scheduleCallback = function (scheduledCallbackData) {
		...
		xhr.setRequestHeader("Access-Control-Allow-Headers", "Origin,X-Requested-With,Content-Type,Accept,Authorization,ININ-Client-Path,Access-Control-Allow-Credentials,Authorization");
